...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko" xml:lang="ko">
 <head> 
  ...
  <!-- 레이아웃 관련 CSS -->      
  <!-- 레이아웃 관련 CSS //--> 
  <script type="text/javascript" src="/LSW/js/jquery/jquery.min.js?Time=1789298709"></script> 
  <script type="text/javascript" src="/LSW/js/common/common.js?Time=1789298709"></script> 
  <script type="text/javascript" src="/LSW/js/common/drag_search.js?Time=1789298709"></script> 
  <script type="text/javascript" src="/LSW/js/common/CookieUtil.js"></script> 
  <script type="text/javascript" src="/LSW/js/jquery/jquery.loadmask.min.js?Time=1789298709"></script> 
  <script type="text/javascript" src="/LSW/js/common/jquery-custom.js?Time=1789298709"></script> 
  <!-- 레이아웃 관련 JS --> 
  <script type="text/javascript" src="/LSW/js/jquery/jquery-ui.js?Time=1789298709"></script> 
  <script type="text/javascript" src="/LSW/js/jquery/jquery-ui_2017.min.js?Time=1789298709"></script> 
  <script type="text/javascript" src="/LSW/js/jquery/jquery.layout-latest.min.js?Time=1789298709"></script> 
  <script type="text/javascript" src="/LSW/js/common/layout.js?Time=1789298709"></script> 
  <!-- 레이아웃 관련 JS //-->  
  <script type="text/javascript">
        var webRoot = '/LSW';
    </script> 
  <link rel="shortcut icon" type="text/css" href="/LSW/images/ico_favorites.ico" />
  <link rel="stylesheet" type="text/css" href="/LSW/css/lsw/common.css?Time=1789298709" />
  <link rel="stylesheet" type="text/css" href="/LSW/js/jquery/jquery.loadmask.css?Time=1789298709" />
  <link rel="stylesheet" type="text/css" href="/LSW/js/jquery/layout-default-latest.css?Time=1789298709" />
  <link rel="stylesheet" type="text/css" href="/LSW/css/lsw/layout.css?Time=1789298709" />
  <link rel="stylesheet" type="text/css" href="/LSW/css/lsw/board.css?Time=1789298709" />
  <link rel="stylesheet" type="text/css" href="/LSW/css/ui_2017.css?Time=1789298709" />
  <link rel="stylesheet" type="text/css" href="/LSW/css/fonts.css?Time=1789298709" />
  <link rel="canonical" href="https://www.law.go.kr/법령/개인정보보호법" />
...
#hisComment { display:  !important; }
</style>
  <title>영문법령 &gt; 본문 &gt; PERSONAL INFORMATION PROTECTION ACT | 국가법령정보센터</title>
 </head> 
 <body id="bodyId"> 
  ...
  <script type="text/javascript" src="/LSW/js/ls/fUpdate.js?Time=1789298709"></script> 
  ...
  <script type="text/javascript" src="/LSW/js/ls/lsLink.js?Time=1789298709"></script> 
...
//<![CDATA[
	...
	function fn_thdCmpResize() {
		...
		//본문이 아니면 좌측 트리 안보이게 수정
		if ($("#west-toggler").attr('title') == 'Close') {
			$('#west-toggler').click();
		}

		document.getElementById('west').style.display = 'none';
		document.getElementById('west-toggler').style.display = 'none';
		document.getElementById('west-resizer').style.display = 'none';
	}
	...
	function checkReferrer(){
		try{
			...
			try {
				...
				// law.go.kr을 이용한 경우. window.parent.document 접근 시 Security Exception 발생. (www.law.go.kr은 문제가 없는데..)
				referrer = "";
			}
			...
			if( !referrer ){
				...
				if( hostName.toUpperCase().indexOf(domain) > -1 || apiGubun === 'api'){
					...
					if( nwYn == "Y" ){
						...
						if (efYd != "99991231" && efYd > todayStr) {
							modal('lsInfoPModal', '이 법은 현행이 아닙니다.', 'LsCurMove' , '현행법령이동', existLsIdCnt);
						} else {
							modal('lsInfoPModal', '이 법은 폐지된 법령입니다.');
						}
					} else if (lapYd != '' && lapYd <= todayStr) {
						if (existLsIdCnt > 0){
							modal('lsInfoPModal', '이 법은 현행이 아닙니다.', 'LsCurMove' , '현행법령이동', existLsIdCnt);
						} else {
							modal('lsInfoPModal', '이 법은 현행이 아닙니다.');
						}
					} else {
	...
	function customResizePop() {
		...
		setTimeout(function() {
            ...
            if (bdyValue == 'lsBdy') {
                ...
                $('#viewwrapCenter').css('overflow-y', 'hidden');
				$('#bodyContentTOP > #viewwrapCenter').height($contentHeight);
				var hisComment = $("#hisComment");
				if((hisComment.length > 0 && hisComment.css('display') != 'none')){
					$('#conScroll').height($('#viewwrapCenter').height() - $conTopHeight - hisComment.height() - 15);
				}else{
					$('#conScroll').height($('#viewwrapCenter').height() - $conTopHeight);
				}
...
//]]>
  ...
  <input type="hidden" id="lsiSeq" value="213857" /> 
  <input type="hidden" id="ancYd" value="20200204" /> 
  <input type="hidden" id="ancNo" value="16930" /> 
  <input type="hidden" id="lsNm" value="개인정보 보호법" /> 
  <input type="hidden" id="lsBdyChrCls" value="010203" /> 
  <input type="hidden" id="target" value="N" /> 
  <input type="hidden" id="lsNmTrim" value="개인정보보호법" /> 
  ...
  <form id="thdForm" method="post" action=""> 
   <input type="hidden" id="lsId" name="lsId" value="011357" /> 
  </form> 
  <form id="searchForm" action="#AJAX"> 
   ...
   <div id="topDiv" class="ui-layout-north"> 
    ...
    <div class="pophead" onclick="window.open('main.html');" onmouseover="this.style.cursor='pointer';"> 
     <h2>영문법령(연혁)</h2> 
     <h2><span id="subTitle" style="display:none"> - PERSONAL INFORMATION PROTECTION ACT</span></h2> 
   ...
   <div id="container"> 
    ...
    <div id="west"> 
     ...
     <div class="lelistwrap" id="leftContent"> 
      <ul> 
       <li id="leftContentLi"> <span class="bl">PERSONAL INFORMATION PROTECTION ACT</span><br /> 
        <div class="subtit1_1">
          [시행 2020. 8. 5.] [법률 제16930호, 2020. 2. 4., 일부개정] 
        </div> </li> 
       <li class="dep"> 
        <div class="dep1" id="SpanJoDt"> 
         <span class="ico" style="cursor: pointer;" onclick="fSelectJoListAncInfoP('SpanJo','999','1','213857','20200805','','');return false;"></span> 
         <a onclick="fSelectJoListAncInfoP('SpanJo','999','1','213857','20200805','','');return false;" href="javascript:;">ARTICLE</a> 
        </div> 
        ...
        <div class="dep1" id="SpanArDt" style="padding-top: 2px;"> 
         <span class="ico" style="cursor: pointer;" onclick="fSelectJoListAncInfoP('SpanAr','2','1','213857','20200805','','');return false;"></span> 
         <a onclick="fSelectJoListAncInfoP('SpanAr','2','1','213857','20200805','','');return false;" href="javascript:;">ADDENDA</a> 
        </div> 
        <div id="SpanAr"></div> </li> 
      </ul> 
     </div> 
     <!-- list //--> 
    </div> 
...
//-->
   ...
   <form id="newSaveForm" name="newSaveForm" target="_self" action="#"> 
    ...
    <div class="bx_inner"> 
     ...
     <div class="ly_cont" id="newSaveLayerLoding"> 
      <div class="ly_tx_bx"> 
       <p class="tx">파일형식</p> 
       <div class="ly_inp_bx" style="width:280px;"> 
        ...
        <input type="radio" id="newSavePDF" name="newSaveExt" value="pdf" /> 
        <label for="newSavePDF">PDF</label> 
       </div> 
      </div> 
      <div class="ly_btn_bx"> 
  ...
  <!-- 신구조문저장 layer //--> 
  <!-- 일괄 저장 layer --> 
  <div class="bx_ly" id="bulkSaveLayer" style="display:none"> 
   <form id="bulkSaveForm" name="bulkSaveForm" target="_self" action="#"> 
    <input type="image" title="전송" alt="전송" style="display:none;" /> 
    <input type="hidden" name="save" value="save" /> 
    <div class="bx_inner"> 
     <p class="ly_tit" style="margin-top: 0px;margin-bottom: 0px;">내용저장</p> 
     <button class="btn_clse" onclick="SaveWindow.hideBulkSave(); return false;"> <span class="blind">닫기</span> </button> 
     <div class="ly_cont" id="bulkSaveLayerLoding"> 
      <div class="ly_tx_bx"> 
       <p class="tx">파일형식</p> 
       <div class="ly_inp_bx"> 
        <input type="radio" id="newBulkSaveHWP" name="newBulkSaveExt" value="hwp" checked="checked" /> 
        <label for="newBulkSaveHWP">HWP</label> 
        <input type="radio" id="newBulkSaveHWPX" name="newBulkSaveExt" value="hwpx" /> 
        <label for="newBulkSaveHWPX">HWPX</label> 
        <input type="radio" id="newBulkSavePDF" name="newBulkSaveExt" value="pdf" /> 
        <label for="newBulkSavePDF">PDF</label> 
        <input type="radio" id="newBulkSaveDOC" name="newBulkSaveExt" value="doc" /> 
        <label for="newBulkSaveDOC">DOC</label> 
       </div> 
      </div> 
      <div class="ly_btn_bx"> 
       <a href="javascript:;" class="btn type" onclick="submitBulkSave();">저장</a> 
       <a href="javascript:;" class="btn type" onclick="SaveWindow.hideBulkSave();">닫기</a> 
      </div> 
     </div> 
    </div> 
   </form> 
  ...
  <script type="text/javascript">
		...
		etcView('engLsInfoR', '213857','','','20200805');
	...
	function modal(id, msg, leftBtnType, leftBtnTitle, existLsIdCnt) {
		...
		if( leftBtnType == "LsCurMove" ){
			...
			modal.querySelector('#leftBtn').addEventListener('click', function() {
				...
				// 해당 법령의 현행이 있다면
				if (existLsIdCnt > 0){
					fLsCurMovePop(lsVO.lsValue.lsNm);
				}else{
